...
const MODEL_RATES: Record<string, { in: number; out: number; label: string }> = {
  ...
  research: { in: 1.0, out: 4.0, label: "gpt-5.6-sol" },
  ...
  design: { in: 0.5, out: 1.5, label: "gpt-5.6-sol+flux" },
  ui: { in: 0.7, out: 2.8, label: "gpt-5.6-sol" },
  branding: { in: 0.5, out: 1.8, label: "gpt-5.6-sol+flux" },
  analysis: { in: 0.9, out: 3.5, label: "gpt-5.6-sol" },
...
function includesForService(serviceId: ServiceId): string[] {
  const map: Record<ServiceId, string[]> = {
    ...
    research: ["Live source retrieval", "Key findings", "Conclusions and caveats"],
    documents: ["Draft", "Formatting", "Quality check"],
    marketing: ["Brief", "Copy variants", "Channel notes"],
    design: ["Concept", "Generated visual", "Handoff notes"],
    ui: ["Layout sketch", "Component notes", "Handoff"],
    branding: ["Direction", "Generated mark", "Usage notes"],
...
export const SERVICE_CATALOG: Array<{ id: ServiceId; name: string; description: string }> = [
  { id: "coding", name: "Coding", description: "Working code, snippets, and review notes" },
  { id: "documents", name: "Documents", description: "Reports, SOPs, school and work docs" },
  {
    id: "research",
    name: "Research",
    description: "Live retrieval from official sources, then findings, conclusions, and caveats",
  },
  { id: "marketing", name: "Marketing", description: "Campaign copy and channel notes" },
  { id: "design", name: "Design", description: "Visual concepts plus a generated creative" },
  { id: "image", name: "Images", description: "Creatives, thumbnails, product shots" },
  { id: "ui", name: "UI", description: "Layouts, components, and handoff notes" },
  { id: "branding", name: "Branding", description: "Mark direction, usage, and a visual" },
  { id: "analysis", name: "Analysis", description: "Findings, trade-offs, and recommendations" },
  { id: "presentations", name: "Presentation", description: "Slide outline, speaker notes, deck copy" },
  { id: "planning", name: "Planning", description: "Goals, milestones, and risks" },
  { id: "agents", name: "Agents", description: "Agent briefs, tools, and guardrails" },

...
export const envSchema = z.object({
  ...
  NVIDIA_BASE_URL: optionalString,
  NVIDIA_MODEL_PRIMARY: optionalString,
  NVIDIA_MODEL_SECONDARY: optionalString,
  NVIDIA_MODEL_TERTIARY: optionalString,
  NVIDIA_TIMEOUT_MS: optionalInt(120000),
  NVIDIA_THINKING_ENABLED: optionalBool,
  NVIDIA_REASONING_EFFORT: optionalString,
  KIMI_API_KEY: optionalString,
  KIMI_BASE_URL: optionalString,
  KIMI_MODEL: optionalString,
  CEREBRAS_API_KEY: optionalString,
  CEREBRAS_BASE_URL: optionalString,
  CEREBRAS_MODEL: optionalString,
  SAMBANOVA_API_KEY: optionalString,
  SAMBANOVA_BASE_URL: optionalString,
  SAMBANOVA_MODEL: optionalString,
  TOGETHER_API_KEY: optionalString,
  TOGETHER_MODEL: optionalString,

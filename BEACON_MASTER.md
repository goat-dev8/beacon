...
| FCC shown as hardware TEE | Misconfig / bad copy | `SIMULATED_TEE`, `FCC_MODE=simulated`, `/v1/fcc/status`, `/health` honesty |
...
- [ ] Hardware FCC / verified enclave when Flare ships a public production path.
